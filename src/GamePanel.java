...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void newBall(){
        ...
        ball.xVelocity= (random.nextInt(4)+1) * (random.nextBoolean() ? 1 : -1 ); // random with negative or positive (not 0)
        ball.yVelocity=(random.nextInt(4)+1)* (random.nextBoolean() ? 1 : -1 );
    }
    ...
    public void checkCollision(){
        ...
        if (ball.intersects(paddle1)){
            ball.xVelocity=Math.abs(ball.xVelocity)+2;
        }
